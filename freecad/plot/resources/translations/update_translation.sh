...
# - The script has to be executed within the `freecad/plot/resources/translations` directory.
...
update_locale() {
	...
	FILES="../../{PlotGui,init_gui}.py \
		../../plot{Axes,Labels,Positions,Save,Series}/TaskPanel.py \
		../ui/*.ui"
